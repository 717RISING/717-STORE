...
export const products: Product[] = [
  {
    ...
    images: ["/products/camisetas/big-dreams-tshirt.jpg"],
  ...
  },
  {
    ...
    images: ["/products/camisetas/oversized-tee.jpg"],
    sizes: ["S", "M", "L", "XL", "XXL"],
    category: "camisetas",
    isNew: true,
  ...
  },
  {
    ...
    images: ["/products/camisetas/graphic-tee-blood.jpg"],
    sizes: ["XS", "S", "M", "L", "XL"],
    category: "camisetas",
  ...
  },
  {
    ...
    images: ["/products/camisetas/graphic-tee-pain.jpg"],
    sizes: ["XS", "S", "M", "L", "XL"],
    category: "camisetas",
