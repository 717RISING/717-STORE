...
export default function EnhancedChatWidget() {
  ...
  return (
    <>
        ...
        {!isOpen && !isMinimized && (
          <>
            <Button
              variant="outline"
              size="sm"
              className="w-12 h-12 rounded-full bg-white hover:bg-gray-50 border-gray-200 shadow-md"
      ...
      {/* Minimized indicator */}
      {isMinimized && (
        <div className="fixed bottom-20 right-4 bg-[#5D1A1D] text-white px-3 py-2 rounded-lg shadow-lg text-sm z-[997]">
